...
public class MerchantActivity extends Activity {
	...
	public void onStartTransaction(View view) {
        ...
        PaytmMerchant Merchant = new PaytmMerchant(
                "https://staging-mirraw-api.herokuapp.com/api/v1/user/orders/generate_paytm_checksum",
                "https://staging-mirraw-api.herokuapp.com/api/v1/user/orders/verify_paytm_checksum");
		...
		Service.startPaymentTransaction(this, true, true,
				new PaytmPaymentTransactionCallback() {
					...
					public void onErrorLoadingWebPage(int iniErrorCode,
						...
						Log.d("WebPageFailed", "Error Loading WebPage " + inErrorMessage + " " + iniErrorCode + " " + inFailingUrl);
					}
